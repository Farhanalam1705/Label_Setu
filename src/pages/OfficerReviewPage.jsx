    ...
    <div className="max-w-4xl mx-auto pb-20 space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-6">
        ...
        <div className="flex items-center gap-2 text-xs text-slate-400 mb-4">
          ...
          <span>/</span>
          <span className="text-slate-700 font-medium">Officer Review</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Review AI-assisted findings before finalizing the inspection.
            </p>
          </div>
        ...
        <div className="mt-5 pt-5 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { label: 'Inspection ID', value: MOCK_INSPECTION_DATA.inspectionId },
            { label: 'Product', value: MOCK_INSPECTION_DATA.product.name },
            {
              label: 'Status',
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold text-slate-900">AI-Assisted Findings</h2>
          <span className="text-xs text-slate-400 ml-1">— Officer Verification Required</span>
        </div>
      ...
      <div className="sticky bottom-4 z-20 bg-white/95 backdrop-blur-md rounded-2xl border border-slate-300/80 p-4 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-xs text-slate-500">
          ...
          <span>
            {reviewedCount}/{REVIEW_FINDINGS.length} findings reviewed
            {!allChecklistDone && ' · Complete checklist'}
            {!reviewState.finalAssessment && ' · Select final assessment'}
          </span>
        </div>
