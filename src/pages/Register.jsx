        ...
        <div className="max-w-xl mx-auto w-full relative z-10 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium mt-0.5 text-rose-200/90">AI-Powered Legal Metrology Compliance Checker</p>
            </div>
          </div>
          ...
          {isComplete ? (
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-rose-800">AI-Powered Legal Metrology Compliance Checker</p>
