      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs animate-in fade-in slide-in-from-top-4 duration-500">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-500">
            Here's your compliance inspection overview.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-600">
          ...
          <div>
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-slate-900">Compliance Overview</h3>
              </div>
              <span className="text-[11px] font-semibold text-slate-400">All Batches</span>
            </div>
            ...
            <div className="relative h-56 w-full my-2 flex items-center justify-center">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Tooltip
                    formatter={(val, name, item) => [`${val}% (${item.payload.count} items)`, name]}
                    contentStyle={{
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
          <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-slate-100 gap-2">
              <div>
                ...
                <p className="text-xs text-slate-500">Inspection compliance performance grouped by commodity type</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
              ...
              <div className="space-y-3.5">
                <div className="group">
                  <div className="flex justify-between text-xs font-semibold mb-1">
                    <span className="text-slate-800">Food & Grains (Rice, Atta, Pulses)</span>
                ...
                <div className="group">
                  <div className="flex justify-between text-xs font-semibold mb-1">
                    <span className="text-slate-800">Beverages & Dairy (Tea, Ghee, Milk)</span>
                ...
                <div className="group">
                  <div className="flex justify-between text-xs font-semibold mb-1">
                    <span className="text-slate-800">Edible Oils (Mustard, Sunflower)</span>
                ...
                <div className="group">
                  <div className="flex justify-between text-xs font-semibold mb-1">
                    <span className="text-slate-800">Bakery & Snacks (Biscuits, Chips)</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex flex-col justify-between hover:bg-slate-100/80 transition-all duration-200 hover:-translate-y-0.5">
                  <span className="text-[11px] font-semibold text-slate-500">Avg. Inspection Speed</span>
                  <div className="mt-2">
                    <span className="text-lg font-bold text-slate-900">0.45s</span>
                    <span className="text-[10px] text-emerald-600 block font-medium mt-0.5">High Performance</span>
                  </div>
                </div>

                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex flex-col justify-between hover:bg-slate-100/80 transition-all duration-200 hover:-translate-y-0.5">
                  <span className="text-[11px] font-semibold text-slate-500">Label Detection Rate</span>
                  <div className="mt-2">
                    <span className="text-lg font-bold text-slate-900">99.4%</span>
                    <span className="text-[10px] text-cyan-600 block font-medium mt-0.5">Mandatory Declarations</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex flex-col justify-between hover:bg-slate-100/80 transition-all duration-200 hover:-translate-y-0.5">
                  ...
                  <div className="mt-2">
                    ...
                    <span className="text-[10px] text-slate-500 block font-medium mt-0.5">In Current Cycle</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex flex-col justify-between hover:bg-slate-100/80 transition-all duration-200 hover:-translate-y-0.5">
                  ...
                  <div className="mt-2">
                    ...
                    <span className="text-[10px] text-slate-500 block font-medium mt-0.5">Central Database</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="pt-4 mt-5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            <span>Data updated in real time from field inspections</span>
            <button
              onClick={handleNewInspection}
              className="text-cyan-700 hover:text-cyan-800 font-bold flex items-center gap-1 hover:underline transition-all hover:translate-x-1"
            >
        ...
        <div className="p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Audit log of recently verified packaged commodities
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search product, ID, brand..."
                value={searchTerm}
              ...
              {filteredInspections.length > 0 ? (
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/90 transition-all duration-150 group">
                    ...
                    <td className="py-3.5 px-5 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold text-cyan-700 hover:text-cyan-800 bg-cyan-50 hover:bg-cyan-100 border border-cyan-200 rounded-lg transition-all duration-150 hover:scale-105 active:scale-95 shadow-2xs"
                      >
                ...
                <tr>
                  <td colSpan={6} className="py-8 text-center text-slate-500 text-xs">
                    No inspections found matching the current search/filter.
                  </td>
                </tr>
              )}
            </tbody>
