...
export const ReportActions = ({ onGenerateAgain, inspectionId, reportId, backPath = '/results', backLabel = 'Back to Results', showGenerateAgain = true, downloadButtonId }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const fileName = reportId ? `LABEL_SETU_Complaint_${reportId}.pdf` : `LABEL_SETU_Inspection_${inspectionId}.pdf`;
      pdf.save(fileName);
