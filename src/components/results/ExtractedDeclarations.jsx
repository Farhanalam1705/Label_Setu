      ...
      <div className="px-5 py-4 border-b border-slate-100 flex flex-wrap items-center justify-between gap-2 bg-slate-50/70">
        <div>
          <h3 className="text-sm font-bold text-slate-900 tracking-tight flex items-center gap-2">
            ...
            <span>{t('extractedDeclarations', 'Extracted Declarations')}</span>
          </h3>
          <p className="text-xs text-slate-500 mt-0.5">
            {t('mandatoryDeclarationsOcr', 'Mandatory packaged commodity declarations recognized by the OCR parser')}
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 text-xs">
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200">
            {compliantCount} {t('valid', 'Valid')}
          </span>
          {reviewCount > 0 && (
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-amber-50 text-amber-800 border border-amber-200">
              {reviewCount} {t('issues', 'Issues')}
            </span>
          )}
        </div>
      </div>
